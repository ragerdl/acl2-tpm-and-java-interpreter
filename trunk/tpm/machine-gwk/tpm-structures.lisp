...
(defthm byte-is-integerp (implies (byte-p x) (integerp x)) 
  :hints (("Goal" :in-theory (enable byte-p)))
...
(defthm uint16-is-integerp (implies (uint16-p x) (integerp x)) 
  :hints (("Goal" :in-theory (enable uint16-p))))
...
(defthm uint32-is-integerp (implies (uint32-p x) (integerp x)) 
  :hints (("Goal" :in-theory (enable uint32-p))))
...
(defthm uint64-is-integerp (implies (uint64-p x) (integerp x)) 
  :hints (("Goal" :in-theory (enable uint64-p))))
...
;; Use this in stany data for the context list
(defprimitive tpmx-context-list (x)
  (and (uint32-list-p x)
       (equal (len x) *tpmx-max-session-list*))
  :default (make-list *tpmx-max-session-list* :initial-element (make-uint32))
  :parents (tpm-structures))

(defthm tpmx-context-list-true-listp-lemma
  (implies (tpmx-context-list-p x)
           (true-listp x))
  :hints (("Goal" :in-theory (enable tpmx-context-list-p))))

(defthm tpmx-context-list-nth-lemma
  (implies (and (<= 0 n)
                (< n *tpmx-max-session-list*)
                (tpmx-context-list-p x))
           (uint32-p (nth n x)))
  :hints (("Goal" :in-theory (enable tpmx-context-list-p))))

(defthm tpmx-context-list-update-nth-lemma
  (implies (and (<= 0 n)
                (< n *tpmx-max-session-list*)
                (tpmx-context-list-p lst)
                (uint32-p val))
           (tpmx-context-list-p (update-nth n val lst)))
  :hints (("Goal" :in-theory (enable tpmx-context-list-p))))
...
;; TPMX: No longer needed as 20-byte-lists objects are now integers
...
(defthm tpm-actual-count-is-integerp (implies (tpm-actual-count-p x) (integerp x)) 
  :hints (("Goal" :in-theory (enable tpm-actual-count-p))))
...
(defthm tpm-authhandle-is-integerp (implies (tpm-authhandle-p x) (integerp x)) 
  :hints (("Goal" :in-theory (enable tpm-authhandle-p))))
...
(defthm tpm-capability-area-is-integerp (implies (tpm-capability-area-p x) (integerp x)) 
  :hints (("Goal" :in-theory (enable tpm-capability-area-p))))
...
(defthm tpm-count-id-is-integerp (implies (tpm-count-id-p x) (integerp x)) 
  :hints (("Goal" :in-theory (enable tpm-count-id-p))))
...
(defthm tpm-delegate-index-is-integerp (implies (tpm-delegate-index-p x) (integerp x)) 
  :hints (("Goal" :in-theory (enable tpm-delegate-index-p))))
...
(defthm tpm-dirindex-is-integerp (implies (tpm-dirindex-p x) (integerp x)) 
  :hints (("Goal" :in-theory (enable tpm-dirindex-p))))
...
(defthm tpm-family-id-is-integerp (implies (tpm-family-id-p x) (integerp x)) 
  :hints (("Goal" :in-theory (enable tpm-family-id-p))))
...
(defthm tpm-family-verification-is-integerp (implies (tpm-family-verification-p x) (integerp x)) 
  :hints (("Goal" :in-theory (enable tpm-family-verification-p))))
...
(defthm tpm-modifier-indicator-is-integerp (implies (tpm-modifier-indicator-p x) (integerp x)) 
  :hints (("Goal" :in-theory (enable tpm-modifier-indicator-p))))
...
(defthm tpm-pcrindex-is-integerp (implies (tpm-pcrindex-p x) (integerp x)) 
  :hints (("Goal" :in-theory (enable tpm-pcrindex-p))))
...
(defthm tpm-redit-command-is-integerp (implies (tpm-redit-command-p x) (integerp x)) 
  :hints (("Goal" :in-theory (enable tpm-redit-command-p))))

;; 3.1 TPM_STRUCTURE_TAG
;; The tag for the structure
(cutil::defenum tpm-structure-tag-p
  (:tpmx-default-enum-value
   :tpm-tag-contextblob
   :tpm-tag-context-sensitive
   :tpm-tag-contextpointer
   :tpm-tag-contextlist
   :tpm-tag-signinfo
   :tpm-tag-pcr-info-long
   :tpm-tag-persistent-flags
   :tpm-tag-volatile-flags
   :tpm-tag-persistent-data
   :tpm-tag-volatile-data
   :tpm-tag-sv-data
   :tpm-tag-ek-blob
   :tpm-tag-ek-blob-auth
   :tpm-tag-counter-value
   :tpm-tag-transport-internal
   :tpm-tag-transport-log-in
   :tpm-tag-transport-log-out
   :tpm-tag-audit-event-in
   :tpm-tag-audit-event-out
   :tpm-tag-current-ticks
   :tpm-tag-key
   :tpm-tag-stored-data12
   :tpm-tag-nv-attributes
   :tpm-tag-nv-data-public
   :tpm-tag-nv-data-sensitive
   :tpm-tag-delegations
   :tpm-tag-delegate-public
   :tpm-tag-delegate-table-row
   :tpm-tag-transport-auth
   :tpm-tag-transport-public
   :tpm-tag-permanent-flags
   :tpm-tag-stclear-flags
   :tpm-tag-stany-flags
   :tpm-tag-permanent-data
   :tpm-tag-stclear-data
   :tpm-tag-stany-data
   :tpm-tag-family-table-entry
   :tpm-tag-delegate-sensitive
   :tpm-tag-delg-key-blob
   :tpm-tag-key11           ;; Added in TPMX to distinguish between 1.1 and 1.2 in new tpm-key structure
   :tpm-tag-key12
   :tpm-tag-certify-info2
   :tpm-tag-delegate-owner-blob
   :tpm-tag-ek-blob-activate
   :tpm-tag-daa-blob
   :tpm-tag-daa-context
   :tpm-tag-daa-enforce
   :tpm-tag-daa-issuer
   :tpm-tag-cap-version-info
   :tpm-tag-daa-sensitive
   :tpm-tag-daa-tpm
   :tpm-tag-cmk-migauth
   :tpm-tag-cmk-sigticket
   :tpm-tag-cmk-ma-approval
   :tpm-tag-quote-info2
   :tpm-tag-da-info
   :tpm-tag-da-info-limited
   :tpm-tag-da-action-type
  )
  :parents(tpm-structures))

(defnd make-tpm-structure-tag ()
  :tpmx-default-enum-value)
...
(defthm tpm-sym-mode-is-integerp (implies (tpm-sym-mode-p x) (integerp x)) 
  :hints (("Goal" :in-theory (enable tpm-sym-mode-p))))
...
(defthm tpm-transhandle-is-integerp (implies (tpm-transhandle-p x) (integerp x)) 
  :hints (("Goal" :in-theory (enable tpm-transhandle-p))))
...
(defthm tpm-transport-attributes-is-integerp (implies (tpm-transport-attributes-p x) (integerp x)) 
  :hints (("Goal" :in-theory (enable tpm-transport-attributes-p))))
...
(defthm tpm-entity-type-is-integerp (implies (tpm-entity-type-p x) (integerp x)) 
  :hints (("Goal" :in-theory (enable tpm-entity-type-p))))
...
(defthm tpm-handle-is-integerp (implies (tpm-handle-p x) (integerp x)) 
  :hints (("Goal" :in-theory (enable tpm-handle-p))))
...
(defthm tpm-version-byte-is-integerp (implies (tpm-version-byte-p x) (integerp x)) 
  :hints (("Goal" :in-theory (enable tpm-version-byte-p))))

;; 5.6 TPM_AUTHDATA()
;; TPMX: formerly a defprimative. Change to defaggregate for consistency with tpm-nonce, tpm-digest, etc.
;; TPMX: formerly 20-byte-list. Change to integer for ease of use
;; TODO: require that value is 20 bytes
(cutil::defaggregate tpm-authdata
  ((value integerp ""
     :default 0)
  )
  :parents(tpm-structures))
...
;; The command ordinal.
(cutil::defenum tpm-command-code-p
  (:tpmx-default-enum-value
   :tpm-ord-activate-identity
   :tpm-ord-authorize-migration-key
   :tpm-ord-certify-key
   :tpm-ord-certify-key2
   :tpm-ord-certify-self-test
   :tpm-ord-change-auth
   :tpm-ord-change-auth-asym-finish
   :tpm-ord-change-auth-asym-start
   :tpm-ord-change-auth-owner
   :tpm-ord-cmk-approve-ma
   :tpm-ord-cmk-convert-migration
   :tpm-ord-cmk-create-blob
   :tpm-ord-cmk-create-key
   :tpm-ord-cmk-create-ticket
   :tpm-ord-cmk-set-restrictions
   :tpm-ord-continue-self-test
   :tpm-ord-convert-migration-blob
   :tpm-ord-create-counter
   :tpm-ord-create-endorsement-key-pair
   :tpm-ord-create-maintenance-archive
   :tpm-ord-create-migration-blob
   :tpm-ord-create-revocable-ek
   :tpm-ord-create-wrap-key
   :tpm-ord-daa-join
   :tpm-ord-daa-sign
   :tpm-ord-delegate-create-key-delegation
   :tpm-ord-delegate-create-owner-delegation
   :tpm-ord-delegate-load-owner-delegation
   :tpm-ord-delegate-manage
   :tpm-ord-delegate-read-table
   :tpm-ord-delegate-update-verification
   :tpm-ord-delegate-verify-delegation
   :tpm-ord-dir-read
   :tpm-ord-dir-write-auth
   :tpm-ord-disable-force-clear
   :tpm-ord-disable-owner-clear
   :tpm-ord-disable-pubek-read
   :tpm-ord-dsap
   :tpm-ord-establish-transport
   :tpm-ord-evict-key
   :tpm-ord-execute-transport
   :tpm-ord-extend
   :tpm-ord-field-upgrade
   :tpm-ord-flush-specific
   :tpm-ord-force-clear
   :tpm-ord-get-audit-digest
   :tpm-ord-get-audit-digest-signed
   :tpm-ord-get-audit-event
   :tpm-ord-get-audit-event-signed
   :tpm-ord-get-capability
   :tpm-ord-get-capability-owner
   :tpm-ord-get-capability-signed
   :tpm-ord-get-ordinal-audit-status
   :tpm-ord-get-pub-key
   :tpm-ord-get-random
   :tpm-ord-get-test-result
   :tpm-ord-get-ticks
   :tpm-ord-increment-counter
   :tpm-ord-init
   :tpm-ord-key-control-owner
   :tpm-ord-kill-maintenance-feature
   :tpm-ord-load-auth-context
   :tpm-ord-load-context
   :tpm-ord-load-key
   :tpm-ord-load-key2
   :tpm-ord-load-key-context
   :tpm-ord-load-maintenance-archive
   :tpm-ord-load-manu-maint-pub
   :tpm-ord-make-identity
   :tpm-ord-migrate-key
   :tpm-ord-nv-define-space
   :tpm-ord-nv-read-value
   :tpm-ord-nv-read-value-auth
   :tpm-ord-nv-write-value
   :tpm-ord-nv-write-value-auth
   :tpm-ord-oiap
   :tpm-ord-osap
   :tpm-ord-owner-clear
   :tpm-ord-owner-read-internal-pub
   :tpm-ord-owner-read-pubek
   :tpm-ord-owner-set-disable
   :tpm-ord-pcr-reset
   :tpm-ord-pcr-read
   :tpm-ord-physical-disable
   :tpm-ord-physical-enable
   :tpm-ord-physical-set-deactivated
   :tpm-ord-quote
   :tpm-ord-quote2
   :tpm-ord-read-counter
   :tpm-ord-read-manu-maint-pub
   :tpm-ord-read-pubek
   :tpm-ord-release-counter
   :tpm-ord-release-counter-owner
   :tpm-ord-release-transport-signed
   :tpm-ord-reset
   :tpm-ord-reset-lock-value
   :tpm-ord-revoke-trust
   :tpm-ord-save-auth-context
   :tpm-ord-save-context
   :tpm-ord-save-key-context
   :tpm-ord-save-state
   :tpm-ord-seal
   :tpm-ord-sealx
   :tpm-ord-self-test-full
   :tpm-ord-set-capability
   :tpm-ord-set-operator-auth
   :tpm-ord-set-ordinal-audit-status
   :tpm-ord-set-owner-install
   :tpm-ord-set-owner-pointer
   :tpm-ord-set-redirection
   :tpm-ord-set-temp-deactivated
   :tpm-ord-sha1complete
   :tpm-ord-sha1complete-extend
   :tpm-ord-sha1start
   :tpm-ord-sha1update
   :tpm-ord-sign
   :tpm-ord-startup
   :tpm-ord-stir-random
   :tpm-ord-take-ownership
   :tpm-ord-terminate-handle
   :tpm-ord-tick-stamp-blob
   :tpm-ord-un-bind
   :tpm-ord-unseal
  )
  :parents(tpm-structures))

(defnd make-tpm-command-code ()
  :tpmx-default-enum-value)
...
(defthm tpm-capability-area-set-is-integerp (implies (tpm-capability-area-set-p x) (integerp x)) 
  :hints (("Goal" :in-theory (enable tpm-capability-area-set-p))))
...
(defthm tpm-redir-command-is-integerp (implies (tpm-redir-command-p x) (integerp x)) 
  :hints (("Goal" :in-theory (enable tpm-redir-command-p))))
...
(cutil::defenum tpm-result-p
  (:tpmx-default-enum-value
   ...
   :tpmx-error                 ;; Error specific to the tpmx implementation
  )
  :parents(tpm-structures))
...
;; 5.4 TPM_DIGEST()
;; TPMX: changed 'digest' byte array field to 'value' integer field
;; TPMX: same for all types that use tpm-digest (see TPM_DIGEST in TCG spec)
;; TODO: Require that the digest is 20 bytes (see TPM_DIGEST)
(cutil::defaggregate tpm-digest
  ((value integerp "This SHALL be the actual digest information"
     :default 0)
  )
  :parents(tpm-structures))
...
;; 5.5 TPM_NONCE()
;; TPMX: changed 'nonce' 20 byte array field to 'value' integer field
;; TODO: Require that the nonce is 20 bytes (see TPM_NONCE)
(cutil::defaggregate tpm-nonce
  ((value integerp "This SHALL be the 20 bytes of random data. When created by the TPM the value MUST be the next 20 bytes from the RNG."
     :default 0)
  )
  :parents(tpm-structures))
...
;; TPMX_SESSION_TYPE
;; TPMX: Used in TPM_SESSION_DATA
;; TPMX: Based on BerliOS session types
(cutil::defenum tpmx-session-type-p
  (:tpmx-st-invalid
   :tpmx-st-oiap
   :tpmx-st-osap
   :tpmx-st-transport
...
;; TPMX: this is a typedef of tpm-digest (see TPM_DIGEST in TCG spec) 
(cutil::defaggregate tpm-auditdigest
  ((value integerp "This SHALL be the actual digest information"
     :default 0)
  )
  :parents(tpm-structures))
...
;; TPMX: this is a typedef of tpm-digest (see TPM_DIGEST in TCG spec) 
(cutil::defaggregate tpm-composite-hash
  ((value integerp "This SHALL be the actual digest information"
     :default 0)
  )
  :parents(tpm-structures))
...
;; TPMX: this is a typedef of tpm-digest (see TPM_DIGEST in TCG spec) 
(cutil::defaggregate tpm-dirvalue
  ((value integerp "This SHALL be the actual digest information"
     :default 0)
  )
  :parents(tpm-structures))
...
;; TPMX: this is a typedef of tpm-digest (see TPM_DIGEST in TCG spec) 
(cutil::defaggregate tpm-pcrvalue
  ((value integerp "This SHALL be the actual digest information"
     :default 0)
  )
  :parents(tpm-structures))
...
;; Use this in stclear data to allow access from indexes 0..23
(defprimitive tpmx-pcrvalue-list (x)
  (and (tpm-pcrvalue-list-p x)
       (equal (len x) *tpmx-num-pcrs*))
  :default (make-list *tpmx-num-pcrs* :initial-element (make-tpm-pcrvalue))
  :parents (tpm-structures))

(defthm tpmx-pcrvalue-list-true-listp-lemma
  (implies (tpmx-pcrvalue-list-p x)
           (true-listp x))
  :hints (("Goal" :in-theory (enable tpmx-pcrvalue-list-p))))

(defthm tpmx-pcrvalue-list-nth-lemma
  (implies (and (<= 0 n)
                (< n *tpmx-num-pcrs*)
                (tpmx-pcrvalue-list-p x))
           (tpm-pcrvalue-p (nth n x)))
  :hints (("Goal" :in-theory (enable tpmx-pcrvalue-list-p))))

(defthm tpmx-pcrvalue-list-update-nth-lemma
  (implies (and (<= 0 n)
                (< n *tpmx-num-pcrs*)
                (tpmx-pcrvalue-list-p lst)
                (tpm-pcrvalue-p val))
           (tpmx-pcrvalue-list-p (update-nth n val lst)))
  :hints (("Goal" :in-theory (enable tpmx-pcrvalue-list-p))))
...
;; TPMX: See comments for TPM_AUTHDATA
(cutil::defaggregate tpm-encauth
  ((valuye integerp ""
     :default 0))
  :parents(tpm-structures))
...
;; Use this in permanent data to allow access to elements 0..23
(defprimitive tpmx-pcr-attributes-list (x)
  (and (tpm-pcr-attributes-list-p x)
       (equal (len x) *tpmx-num-pcrs*))
  :default (make-list *tpmx-num-pcrs* :initial-element (make-tpm-pcr-attributes))
  :parents (tpm-structures))

(defthm tpmx-pcr-attributes-list-true-listp-lemma
  (implies (tpmx-pcr-attributes-list-p x)
           (true-listp x))
  :hints (("Goal" :in-theory (enable tpmx-pcr-attributes-list-p))))

(defthm tpmx-pcr-attributes-list-nth-lemma
  (implies (and (<= 0 n)
                (< n *tpmx-num-pcrs*)
                (tpmx-pcr-attributes-list-p x))
           (tpm-pcr-attributes-p (nth n x)))
    :hints (("Goal" :in-theory (enable tpmx-pcr-attributes-list-p))))

(defthm tpmx-pcr-attributes-list-update-nth-lemma
  (implies (and (<= 0 n)
                (< n *tpmx-num-pcrs*)
                (tpmx-pcr-attributes-list-p lst)
                (tpm-pcr-attributes-p val))
           (tpmx-pcr-attributes-list-p (update-nth n val lst)))
  :hints (("Goal" :in-theory (enable tpmx-pcr-attributes-list-p))))
...
(cutil::defaggregate tpm-key-parms
  ((algorithm-id tpm-algorithm-id-p "This SHALL be the key algorithm in use"
   ...
   (sig-scheme tpm-sig-scheme-p "This SHALL be the signature scheme that the key uses to perform digital signatures"
     :default (make-tpm-sig-scheme))
   (rsa tpm-rsa-key-parms-p "This SHALL be the parameter information for the RSA key algorithm."
     :default (make-tpm-rsa-key-parms))
   (sym tpm-symmetric-key-parms-p "This SHALL be the parameter information for a symmetric key algorithm."
     :default (make-tpm-symmetric-key-parms))
  )
  :parents(tpm-structures))
...
(cutil::defaggregate tpm-stclear-data
  ((tag tpm-structure-tag-p "TPM_TAG_STCLEAR_DATA"
   ...
   (disable-reset-lock booleanp "Disables TPM_ResetLockValue upon authorization failure. The value remains TRUE for the timeout period. Default is FALSE. The value is in the STCLEAR_DATA structure as the implementation of this flag i ..."
     :default nil)
   (pcr tpmx-pcrvalue-list-p "Platform configuration registers [tpmx: length = *tpmx-num-pcrs*]"
     :default (make-tpmx-pcrvalue-list))
...
;; TPMX NOTE: New tpm-key
;;
;; This new TPMX structure consolidates elements of TPM_KEY and TPM_KEY12.
;; 
;; - The parameter 'ver' of TPM_KEY was eliminated as TpmStructVer objects always have value 1.1.0.0 and do not add information to the structure.
;; - The parameter 'tag' of TPM_KEY12 was retained, and the enumeration value :tpm-tag-key11 was added to tpm-structure-tag to allow clients
;;   to discriminate between uses of this structure as TPM_KEY and TPM_KEY12
;; - The parameter 'fill' was eliminated as its value is always 0x0000 and adds no information
;; - The parameter 'pcrInfo' has type TPM_PCR_INFO in TPM_KEY and TPM_PCR_INFO_LONG in TPM_KEY12. As the fields of TPM_PCR_INFO_LONG subsume
;;   fields of TPM_PCR_INFO, this parameter was replaced by an object of type 'tpm-pcr-info-long'
;; - The parameter 'encData' is either an encrypted TPM_STORE_ASYMKEY or a TPM_MIGRATE_ASYMKEY. It has been replaced with two parameters:
;;   'store-asymkey' and 'migrate-asymkeyData'. At some point, we may want to consolidate the structures TPM_STORE_ASYMKEY
;;   and TPM_MIGRATE_ASYMKEY. 
;;
(cutil::defaggregate tpm-key
  ((tag tpm-structure-tag-p "MUST be TPM_TAG_KEY12 or TPM_TAG_KEY11"
     :default (make-tpm-structure-tag))
   (key-usage tpm-key-usage-p "This SHALL be the TPM key usage that determines the operations permitted with this key"
     :default (make-tpm-key-usage))
   (key-flags tpm-key-flags-p "This SHALL be the indication of migration, redirection etc."
   ...
   (algorithm-parms tpm-key-parms-p "This SHALL be the information regarding the algorithm for this key"
     :default (make-tpm-key-parms))
   (pcr-info tpm-pcr-info-long-p "This SHALL be a structure of type TPM_PCR_INFO_LONG"
     :default (make-tpm-pcr-info-long))
   (pub-key tpm-store-pubkey-p "This SHALL be the public portion of the key"
     :default (make-tpm-store-pubkey))
   (store-asymkey tpm-store-asymkey-p "This SHALL be an encrypted TPM_STORE_ASYMKEY structure"
     :default (make-tpm-store-asymkey))
   (migrate-asymkey tpm-migrate-asymkey-p "This SHALL be an encrypted TPM_MIGRATE_ASYMKEY structure"
     :default (make-tpm-migrate-asymkey))
  )
  :parents(tpm-structures))
...
; GWK: Moved tpm-session-data here as BerliOS implementation uses previous structures

;; 7.6 TPM_SESSION_DATA()
;; TPMX: TCG states that this is "vendor specific"
;; TPMX: Ours is based on BerliOS session data
(cutil::defaggregate tpm-session-data
  ((session-type tpmx-session-type-p ""
     :default (make-tpmx-session-type))
   (nonce-even tpm-nonce-p ""
     :default (make-tpm-nonce))
   (last-nonce-even tpm-nonce-p ""
     :default (make-tpm-nonce))
   (shared-secret tpm-secret-p ""
     :default (make-tpm-secret))
   (handle tpm-handle-p ""
     :default (make-tpm-handle))
   (entity-type tpm-entity-type-p ""
     :default (make-tpm-entity-type))
   (permissions tpm-delegations-p ""
     :default (make-tpm-delegations))
   (familty-id tpm-family-id-p ""
     :default (make-tpm-family-id))
   (trans-internal tpm-transport-internal-p ""
     :default (make-tpm-transport-internal)))
  :parents(tpm-structures))
...
;; Use this in stany data for the sessions list
(defprimitive tpmx-session-data-list (x)
  (and (tpm-session-data-list-p x)
       (equal (len x) *tpmx-max-sessions*))
  :default (make-list *tpmx-max-sessions* :initial-element (make-tpm-session-data))
  :parents (tpm-structures))
#|
(defthm tpmx-session-data-list-car-is-tpm-session-data
  (implies (tpmx-session-data-list-p x)
           (tpm-session-data-p (car x)))
  :hints (("Goal" :in-theory (enable tpmx-session-data-list-p))))

(defthm tpmx-session-data-list-cdr-is-tpmx-session-data-list
  (implies (tpmx-session-data-list-p x)
           (tpm-session-data-list-p (cdr x)))
  :hints (("Goal" :in-theory (enable tpmx-session-data-list-p))))
|#
(defthm tpmx-session-data-list-true-listp-lemma
  (implies (tpmx-session-data-list-p x)
           (true-listp x))
  :hints (("Goal" :in-theory (enable tpmx-session-data-list-p))))

(defthm tpmx-session-data-list-nth-lemma
  (implies (and (<= 0 n)
                (< n *tpmx-max-sessions*)
                (tpmx-session-data-list-p x))
           (tpm-session-data-p (nth n x)))
  :hints (("Goal" :in-theory (enable tpmx-session-data-list-p))))

(defthm tpmx-session-data-list-update-nth-lemma
  (implies (and (<= 0 n)
                (< n *tpmx-max-sessions*)
                (tpmx-session-data-list-p lst)
                (tpm-session-data-p val))
           (tpmx-session-data-list-p (update-nth n val lst)))
  :hints (("Goal" :in-theory (enable tpmx-session-data-list-p))))
...
(cutil::defaggregate tpm-stany-data
  ((tag tpm-structure-tag-p ""
     :default (make-tpm-structure-tag))
   (context-nonce-session tpm-nonce-p ""
     :default (make-tpm-nonce))
   (audit-digest tpm-digest-p ""
     :default (make-tpm-digest))
   (current-ticks tpm-current-ticks-p ""
     :default (make-tpm-current-ticks))
   (context-count uint32-p ""
     :default (make-uint32))
   (context-list tpmx-context-list-p ""
     :default (make-tpmx-context-list))
   (sessions tpmx-session-data-list-p ""
     :default (make-tpmx-session-data-list))
...
(cutil::defaggregate tpm-permanent-data
  ((tag tpm-structure-tag-p "TPM_TAG_PERMANENT_DATA"
   ...
   (pcr-attrib tpmx-pcr-attributes-list-p "The attributes for all of the PCR registers supported by the TPM. [tpmx: length = *tpmx-num-pcrs*]"
     :default (make-tpmx-pcr-attributes-list))
