...
(defthm tpm-authhandlefamily-id-is-integerp (implies (tpm-family-id-p x) (integerp x)) 
...
(defthm tpmx-pcr-arrtibutes-list-nth-lemma
  (implies (and (<= 0 n)
                (< n *tpmx-num-pcrs*)
